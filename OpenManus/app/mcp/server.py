...
class MCPServer:
    ...
    def __init__(self, name: str = "openmanus"):
        ...
        self.tools["research_tools"] = ResearchTools()
        self.tools["send_email"] = EmailTool()
    ...
    def run(self, transport: str = "stdio") -> None:
        ...
        logger.info(f"Starting LuminAgent server ({transport} mode)")
        self.server.run(transport=transport)


def parse_args() -> argparse.Namespace:
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(description="LuminAgent MCP Server")
    parser.add_argument(
        "--transport",
        choices=["stdio"],
        default="stdio",
